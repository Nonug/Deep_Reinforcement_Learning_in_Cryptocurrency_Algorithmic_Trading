...
class TradingSimulator:
    ...
    def aiTrain(self, strategyName, cryptocurrencyName, PARAM,
        ...
        animation = PARAM['animation'] # bool: enable animation
    ...
    def test(self, strategyName, trainCryptocurrencyName, testCryptocurrencyName, TRAIN_PARAM, TEST_PARAM,
            rendering=True, showPerformance=True, suffix = ''):
        # list of TRAIN_PARAM
        # ['startingDate']
        # ['endingDate']
        # ['money']
        ...
        if suffix != '':
            suffix = suffix + '_'
        if ai:
            fileName = os.path.join("Strategies", strategy+'_'+network+'_'+suffix+trainCryptocurrency)
        else:
